...
export class SubscriptionManager {
    ...
    async buy() {
        ...
        browser.location = `https://www.hotcodes.io/odoo-enterprise/upgrade?num_users=${nbUsers}`;
    }
    /**
    ...
    async renew() {
        ...
        const url = "https://www.hotcodes.io/odoo-enterprise/renew";
    ...
    async upsell() {
        ...
        const url = "https://www.hotcodes.io/odoo-enterprise/upsell";
        const contractQueryString = enterpriseCode ? `&contract=${enterpriseCode}` : "";
